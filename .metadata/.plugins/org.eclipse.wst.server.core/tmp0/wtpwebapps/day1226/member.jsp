				...
				<table border="1" cellpadding="2" cellspacing="0" align="center">
					<form name="regForm" method="post" action="memberProc.jsp">
						...
						<tr>
							...
							<td width="200">
								<input type="password" name="pwd2" size="15" required="required">
							</td>
							<td width="200">패스워드를 적어주세요</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td width="200">
								<input type="text" name="birth" size="15" required="required">
							</td>
						...
						<tr>
							<td width="100">이메일</td>
							<td width="200">
								<input type="email" name="email" size="15" required="required">
							</td>
